	...
	$('#bu1').click(function(){
		...
		$.ajax({
			...
			success : function(result){
				if(result == 1){
					$('#checkMessage').html('사용할 수 있는 아이디');
					$('#checkType').attr('class','modal-content panel-success');
				}else{
					$('#checkMessage').html('사용할 수 없는 아이디');
					$('#checkType').attr('class','modal-content panel-success');
				}
				...
				<tbody>
					<tr>
						...
						<td style="width: 110px;"><button class="btn btn-primary"
								id="bu1" type="button">중복체크</button></td>
					</tr>
					<tr>
							...
							<div class="form-group"
								...
								<div class="btn-group" data-toggle="buttons">
									<label class="btn btn-primary active"> <input
										type="radio" value="남" name="userGender" autocomplete="off"
										checked>남자
									</label> <label class="btn btn-primary"> <input type="radio"
										value="여" name="userGender" autocomplete="off">여자
									</label>
								</div>
							</div>
						</td>
					...
					<tr>
						<td style="width: 110px;"><h5>이메일을 입력하세요</h5></td>
						<td colspan="2"><input type="email" class="form-control"
							id="userEmail" name="userEmail" maxlength="20"></td>
					</tr>
					<tr>
						<td colspan="3" style="text-align:left;"><h5 style="color:red;" id="passwordCheckMessage"></h5><input class="btn btn-primary pull-right" type="submit" value="등록"></td>
					</tr>
				</tbody>
			</table>
		</form>
